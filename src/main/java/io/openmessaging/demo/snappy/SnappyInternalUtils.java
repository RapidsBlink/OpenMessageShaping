...
final class SnappyInternalUtils
{
    ...
    static {
        ...
        if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
            try {
                Class<? extends Memory> unsafeMemoryClass = SnappyInternalUtils.class.getClassLoader().loadClass("io.openmessaging.demo.snappy.UnsafeMemory").asSubclass(Memory.class);
        ...
        if (memoryInstance == null) {
            try {
                Class<? extends Memory> slowMemoryClass = SnappyInternalUtils.class.getClassLoader().loadClass("io.openmessaging.demo.snappy.SlowMemory").asSubclass(Memory.class);
