...
import io.openmessaging.demo.net.jpountz.util.Native;
import io.openmessaging.demo.net.jpountz.util.Utils;
...
import static io.openmessaging.demo.net.jpountz.lz4.LZ4Constants.DEFAULT_COMPRESSION_LEVEL;
import static io.openmessaging.demo.net.jpountz.lz4.LZ4Constants.MAX_COMPRESSION_LEVEL;
...
public final class LZ4Factory {
    ...
    private LZ4Factory(String impl) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        this.impl = impl;
        fastCompressor = classInstance("io.openmessaging.demo.net.jpountz.lz4.LZ4" + impl + "Compressor");
        highCompressor = classInstance("io.openmessaging.demo.net.jpountz.lz4.LZ4HC" + impl + "Compressor");
        fastDecompressor = classInstance("io.openmessaging.demo.net.jpountz.lz4.LZ4" + impl + "FastDecompressor");
        safeDecompressor = classInstance("io.openmessaging.demo.net.jpountz.lz4.LZ4" + impl + "SafeDecompressor");
