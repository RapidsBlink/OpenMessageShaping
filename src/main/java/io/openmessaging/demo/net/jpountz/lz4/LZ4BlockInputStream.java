...
import io.openmessaging.demo.net.jpountz.xxhash.StreamingXXHash32;
import io.openmessaging.demo.net.jpountz.xxhash.StreamingXXHash32JavaUnsafe;
import io.openmessaging.demo.net.jpountz.xxhash.XXHash32;
import io.openmessaging.demo.net.jpountz.xxhash.XXHashFactory;
...
import static io.openmessaging.demo.net.jpountz.lz4.LZ4BlockOutputStream.*;
...
public final class LZ4BlockInputStream extends FilterInputStream {
  ...
  public LZ4BlockInputStream(InputStream in, LZ4FastDecompressor decompressor) {
    this(in, decompressor, new StreamingXXHash32JavaUnsafe(DEFAULT_SEED).asChecksum());
  }
