...
public final class XXHashFactory {
  ...
  private XXHashFactory(String impl) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
    this.impl = impl;
    hash32 = classInstance("net.XXHash32" + impl);
    streamingHash32Factory = classInstance("net.StreamingXXHash32" + impl + "$Factory");
    hash64 = classInstance("net.XXHash64" + impl);
    streamingHash64Factory = classInstance("net.StreamingXXHash64" + impl + "$Factory");
